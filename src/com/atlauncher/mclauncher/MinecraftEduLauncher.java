...
public class MinecraftEduLauncher {
    ...
    public static Process launch(Account account, Instance instance, AuthenticationResponse response)
        ...
        cpb.append(File.pathSeparator);
        cpb.append(new File(instance.getLibrariesDirectory(), "worldedit-5.5.6.jar"));
        cpb.append(File.pathSeparator);
        cpb.append(new File(instance.getLibrariesDirectory(), "mceduforge0.jar"));
        cpb.append(File.pathSeparator);
        cpb.append(new File(instance.getBinDirectory(), "launchwrapper-1.8.jar"));
        ...
        cpb.append(File.pathSeparator);
        cpb.append(instance.getMinecraftEduJar());
        ...
        if (Utils.isMac()) {
            ...
            arguments.add("-Xdock:icon="
                    + new File(App.settings.getImagesDir(), "edu_icon_32x32.png")
                            .getAbsolutePath());
            arguments.add("-Xdock:name=\"" + instance.getName() + "\"");
        }

        libp.append(instance.getNativesDirectory());
        libp.append(File.pathSeparator);
        libp.append(instance.getLibrariesDirectory());
        arguments.add("-Djava.library.path=" + libp.toString());
        ...
        if (instance.hasMinecraftArguments()) {
            ...
            for (String argument : minecraftArguments) {
                ...
                argument = argument.replace("${version_name}", instance.getMinecraftEduVersion());
            ...
            arguments.add("--version=" + "mceduforge");
        ...
        App.settings.log("Launching MinecraftEdu with the following arguments: " + arguments);
