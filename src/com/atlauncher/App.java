    ...
    public static void main(String[] args) {
        ...
        if (Utils.isLinux()) {
            try {
                ...
                config = new File(System.getProperty("user.dir"), "TechnoLauncher");
            }
        } else {
        ...
        settings.log("TechnoLauncher Version: " + settings.getVersion());
        ...
        if (Utils.isMac()) {
            ...
            System.setProperty("com.apple.mrj.application.apple.menu.about.name", "TechnoLauncher "
                    + settings.getVersion());
            try {
